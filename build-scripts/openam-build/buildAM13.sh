...
mkdir maven
cd maven
git clone https://github.com/aldaris/xui-deps.git
cd xui-deps
./install.sh
cd ../../commons/forgerock-parent-public
git checkout 1.2.9
build
git checkout 2.0.6
build
...
build
cd ..
git clone https://stash.forgerock.org/scm/commons/forgerock-ui-public.git
cd forgerock-ui-public
git checkout 8.6.0
build
git checkout 11.0.13
build
cd ..
